...
const ipgeolocation = 'https://api.ipgeolocation.io/ipgeo?apiKey=65fb5e92df844197a0b309cfa6062ffb';
...
$(document).ready(() => {
  ...
  for (let i in links) {
    ...
    $('#marquee').append(`<a href="https://discord.gg/qEKdBaz7VD" target="_BLANK"> « steam artworks »     </a>`);
    $('#marquee').append(`<a href="https://github.com/toasty8i" target="_BLANK"> « github »     </a>`);
    $('#marquee').append(`<a href="https://discord.gg/NyVcunUFSt" target="_BLANK"> « discord »     </a>`);
    $('#marquee').append(`<a href="https://steamcommunity.com/profiles/${link.link}" target="_BLANK">${link.name}</a>`);
    $('#marquee').append(`<a href="https://discord.gg/qEKdBaz7VD" target="_BLANK"> « steam artworks »     </a>`);
    $('#marquee').append(`<a href="https://github.com/toasty8i" target="_BLANK"> « github »     </a>`);
    $('#marquee').append(`<a href="https://discord.gg/NyVcunUFSt" target="_BLANK"> « discord »     </a>`);
    ...
    $('#marquee').append(`<a href="https://discord.gg/NyVcunUFSt" target="_BLANK"> « discord »     </a>`);
    $('#marquee').append(`<a href="https://steamcommunity.com/profiles/${link.link}" target="_BLANK">${link.name}</a>`);
    $('#marquee').append(`<a href="https://discord.gg/qEKdBaz7VD" target="_BLANK"> « steam artworkss »     </a>`);
    $('#marquee').append(`<a href="https://github.com/toasty8i" target="_BLANK"> « github »     </a>`);
    $('#marquee').append(`<a href="https://discord.gg/NyVcunUFSt" target="_BLANK"> « discord »     </a>`);
    $('#marquee').append(`<a href="https://steamcommunity.com/profiles/${link.link}" target="_BLANK">${link.name}</a>`);
    $('#marquee').append(`<a href="https://discord.gg/qEKdBaz7VD" target="_BLANK"> « steam artworks »     </a>`);
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>[toasty8i.github.io]</span>..."], 30, () => {
